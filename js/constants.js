...
const talents = {
    ...
    autoControl:  { name: "Manual Override",   desc: "Unlocks an On/Off toggle for each box's Auto-Bot so you can manage synergies manually.", level: 0, maxLevel: 1,  baseCost: 3, costMult: 1,   requires: 'synergy' },
