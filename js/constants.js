...
const talents = {
    ...
    autoControl: { name: "Manual Override", desc: "Unlocks an On/Off toggle for each box's Auto-Bot so you can manage synergies manually.", level: 0, maxLevel: 1, baseCost: 3, costMult: 1 }
};

const boxData = [
    { id: 0, active: true,  color: 'var(--accent-0)', name: 'BOX 1', unlockCost: 0, jumps: 0, prestige: 0, evolution: 0, totalIncome: 0, bestJump: 0, equippedCard: null, collapsed: false, autoEnabled: true,
    ...
    { id: 1, active: false, color: 'var(--accent-1)', name: 'BOX 2', unlockCost: 5000, jumps: 0, prestige: 0, evolution: 0, totalIncome: 0, bestJump: 0, equippedCard: null, collapsed: false, autoEnabled: true,
    ...
    { id: 2, active: false, color: 'var(--accent-2)', name: 'BOX 3', unlockCost: 250000, jumps: 0, prestige: 0, evolution: 0, totalIncome: 0, bestJump: 0, equippedCard: null, collapsed: false, autoEnabled: true,
    ...
    { id: 3, active: false, color: 'var(--accent-3)', name: 'BOX 4', unlockCost: 5000000, jumps: 0, prestige: 0, evolution: 0, totalIncome: 0, bestJump: 0, equippedCard: null, collapsed: false, autoEnabled: true,
